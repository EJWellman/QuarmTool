...
<li><s>Program will check for updates on startup and self update if required, but if you want to check for a new Update, use the menu in the system tray!</s> Coming in a future update.</li>
</ul>
Features:
<br/>
<ul>
