...
namespace EQTool.Services
{
    public class MapLoad
    {
        ...
        public class AABB
        {
            ...
            public double MaxHeight => (Max.Y == double.MinValue || Min.Y == double.MaxValue ? 600 : Max.Y - Min.Y) + 50d;
            public double MaxWidth => (Max.X == double.MinValue || Min.X == double.MaxValue ? 600 : Max.X - Min.X) + 50d;
        }
