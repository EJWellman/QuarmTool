...
namespace EQTool.Constants
{
	...
	{
		private const int RespawnReductionDungeonLowerBoundMin = 300000; /// <summary> 5 Minutes </summary> 
		...
		private const int RespawnReductionLowerBoundMin = 12000; /// <summary> 12 seconds </summary>
		private const int RespawnReductionLowerBoundMax = 60000; /// <summary> 1 minute </summary>
		private const int RespawnReductionLowerBound = 11999; /// <summary> 11.999 seconds </summary>
