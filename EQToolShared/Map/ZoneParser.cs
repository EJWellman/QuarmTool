...
namespace EQToolShared.Map
{
	...
	public static class ZoneParser
	{
		...
		static ZoneParser()
		{
			...
			ZoneNames.Add(new ZoneNameInfo("plane of justice", "pojustice"));
			ZoneNames.Add(new ZoneNameInfo("halls of injustice", "pojustice"));
			ZoneNames.Add(new ZoneNameInfo("halls of injustice 2", "pojustice"));
			ZoneNames.Add(new ZoneNameInfo("halls of injustice 3", "pojustice"));
			ZoneNames.Add(new ZoneNameInfo("halls of injustice 4", "pojustice"));
			ZoneNames.Add(new ZoneNameInfo("halls of injustice 5", "pojustice"));
			ZoneNames.Add(new ZoneNameInfo("halls of injustice 6", "pojustice"));
			ZoneNames.Add(new ZoneNameInfo("halls of injustice, 30 ward", "pojustice"));
			ZoneNames.Add(new ZoneNameInfo("halls of injustice, 40 ward", "pojustice"));
			ZoneNames.Add(new ZoneNameInfo("halls of injustice, 50 ward", "pojustice"));
